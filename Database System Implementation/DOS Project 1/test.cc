...
const char *dbfile_dir = "/cise/tmp/dbfiles/"; // dir where binary heap files should be stored
const char *tpch_dir = "/cise/tmp/tpch-dbgen/"; // dir where dbgen tpch files (extension *.tbl) can be found
...
int main () {
	...
	void (*test) ();
	relation *rel_ptr[] = {r, n, s, c, p, ps, o, li};
